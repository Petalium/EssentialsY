...
public class ActiveTpas {
    public static ArrayList<Player> activeRecipients = new ArrayList<>(); //holds recipients for active requests
    public static ArrayList<CommandSender> activeSenders = new ArrayList<>(); //holds senders for active requests
